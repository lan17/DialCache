...
generate_feature shadow 512 2048 60 oneSourcePerCaller writesRequireMiss writesHaveRetention agesRequireVerdicts warningsRequireMismatch missingHookHasNoShadowEffects
