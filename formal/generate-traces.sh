...
generate_feature recovery 512 4096 60 singleReadPerFlight pendingDecodeHasCall writesHaveRetention sourcesMatchEffects onlyRegisteredSourceOwnsDeadline agesRequireRecovery closedScopesHaveNoMemo
generate_feature policy 512 2048 60 writesHaveRetention hitsSkipSource callsKeepSourceOutcome sourceCountsMatchEffects registeredSourcesArePending sharedSourcesKeepRegistration
...
generate_feature shadow 1024 4096 60 oneSourcePerCaller writesRequireMiss writesHaveRetention agesRequireVerdicts warningsRequireMismatch missingHookHasNoShadowEffects
...
generate_feature layers 512 2048 80 sourceEffectsMatch capacityIsPerInstance closedScopesHaveNoMemo registeredSourcesArePending zeroCapacityHasNoLocalValues callsKeepSourceOutcome localMembershipMatchesLru absentRemoteHasNoAdapterEffects
generate_feature independent 512 2048 60 oneReadPerCall effectsMatchOwners completedCallsHaveNoActiveWork retainedSnapshotsWereEligible abortsAreUnique writesKeepCapturedRetention
