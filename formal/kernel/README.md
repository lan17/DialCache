...
channel) are exercised by small profiles under `test/fixtures/kernel`. Each
...
classes, the compression channel variants and the marker lifetime). It keeps
