...
`policy-inclusive-local-expiry` partition; the run settles its source one
millisecond after the call so the drivers' advances (1 ms, 60 s, 120 s) reach
the expiry instant itself.
