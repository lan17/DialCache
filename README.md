...
| `unclassified` | The miss was real but cannot be attributed to any prior category, including unrecognized custom-adapter results, short or unsupported frames, malformed watermark metadata paired with a present frame, invalid or future timestamps, and caller-side deserialization failures. |
