...
| `unclassified` | The miss was real but cannot be attributed to any prior category, including legacy/custom Redis `null`, short or unsupported frames, malformed metadata, invalid or future timestamps, and caller-side deserialization failures. |
