...
mod tests {
    ...
    /// Port of go/internal/dialcache/codec_test.go TestCompressionLimitsAndIndependentLoads.
    #[test]
    ...
    /// Port of go/internal/dialcache/codec_test.go TestZstdFirstFrameAndMalformedBodies.
    #[test]
